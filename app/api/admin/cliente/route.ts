...
export async function POST(req: NextRequest) {
  ...
  const {
    ...
    modulo_cobranca,
    modulo_meta_ads,
    modulo_contratos_assinaturas,
    modulo_contratos_plano,
    modulo_contratos_com_crm,
    modulo_equipes,
  ...
  try {
    ...
    const { error: cadError } = await supabase.from("cadastros").insert([{
      ...
      modulo_contratos_assinaturas: !!modulo_contratos_assinaturas,
      modulo_contratos_plano: ['essencial', 'profissional', 'empresarial'].includes(String(modulo_contratos_plano)) ? modulo_contratos_plano : 'essencial',
      modulo_contratos_com_crm: modulo_contratos_com_crm !== false,
