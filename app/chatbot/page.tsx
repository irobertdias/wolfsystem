...
export default function Chatbot() {
  ...
  const atendimentosFiltrados = atendimentos
    .filter(a => abaConversa === "abertos" ? a.status === "aberto" : abaConversa === "pendentes" ? a.status === "em_atendimento" : abaConversa === "resolvidos" ? a.status === "resolvido" : true)
                ...
                <>
                  <div style={{ padding: "12px 20px", borderBottom: "1px solid #1f2937", background: "#111", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      {atendimentoAtivo.atendente === "BOT" && <button onClick={() => assumirChat(atendimentoAtivo.numero)} style={{ background: "#3b82f622", color: "#3b82f6", border: "1px solid #3b82f633", borderRadius: 8, padding: "6px 14px", fontSize: 12, cursor: "pointer", fontWeight: "bold" }}>👤 Assumir</button>}
                      {atendimentoAtivo.atendente !== "BOT" && <button onClick={() => devolverBot(atendimentoAtivo.numero)} style={{ background: "#8b5cf622", color: "#8b5cf6", border: "1px solid #8b5cf633", borderRadius: 8, padding: "6px 14px", fontSize: 12, cursor: "pointer", fontWeight: "bold" }}>🤖 Devolver ao Bot</button>}
