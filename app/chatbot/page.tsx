...
function ChatbotInner() {
  ...
  const menus = [
    ...((permissoes.chat_proprio || permissoes.chat_todos || permissoes.dashboard) ? [{
      key: "atendimentos", icon: "💬", label: "Atendimentos", cor: "#3b82f6",
      subitens: [
      ...
      <div style={{
        ...
        <div style={{ padding: 16, borderBottom: "1px solid #e5e7eb", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, flex: 1, minWidth: 0 }}>
            <img src="/logo1.png" alt="Wolf" style={{ width: 32, flexShrink: 0 }} />
            <div style={{ minWidth: 0 }}>
              <span style={{ color: "#1f2937", fontWeight: "700", fontSize: 14, display: "block" }}>Wolf Chatbot</span>
