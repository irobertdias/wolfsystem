...
// ═══════════════════════════════════════════════════════════════════════
// Substitui alert() em todo o sistema. Uso em qualquer componente:
//
...
//
// Pra funcionar: <ToastProvider> precisa envolver a árvore React (no layout.tsx root).
// ═══════════════════════════════════════════════════════════════════════
...
const CORES_POR_TIPO: Record<TipoToast, { bg: string; border: string; icon: string }> = {
  sucesso: { bg: "#16a34a", border: "#15803d", icon: "✅" },
...
export function useToast(): ToastContextValue {
  ...
  if (!ctx) {
    // Fallback: se alguém usar useToast() fora do Provider, ainda funciona
    // (loga no console em vez de quebrar)
    return {
...
// ─── Componente que renderiza os toasts (fixed no canto inferior direito) ───
