...
export default function CRMLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    // 🆕 Envolve todo o conteúdo em SoftphoneProvider — permite acessar useSoftphone de qualquer página filha
    <SoftphoneProvider>
      <div style={{ display: "flex", height: "100vh", fontFamily: "Arial, sans-serif", background: "#0a0a0a" }}>
        ...
        {/* 🆕 Softphone flutuante — sempre renderizado, canto inferior direito */}
        <Softphone />
      </div>
    </SoftphoneProvider>
  );
